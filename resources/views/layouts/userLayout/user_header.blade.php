    ...
    <li  class="dropdown" id="profile-messages" ><a title="" href="#" data-toggle="dropdown" data-target="#profile-messages" class="dropdown-toggle"><i class="glyphicon glyphicon-chevron-down"></i>  <span class="text">Bienvenido {{ Auth::user()->name }}</span><b class="caret"></b></a>
      <ul class="dropdown-menu">
       <!-- <li><a href="#"><i class="icon-user"></i> My Profile</a></li>-->
        <li class="divider"></li>
        <li><a href="{{ url('/user/settings') }}"><i class="glyphicon glyphicon-cog"></i> Configuracion</a></li>
        <li class="divider"></li>
        <li><a href="{{url('/logout')}}"><i class="glyphicon glyphicon-log-out"></i> Log Out</a></li>
      </ul>
    </li>
    
    <li class=""><a title="" href="{{ url('/user/settings') }}"><i class="glyphicon glyphicon-cog"></i> <span class="text">Configurar</span></a></li>
    <li class=""><a title="" href="{{ url('/user/logout')}}"><i class="glyphicon glyphicon-log-out"></i> <span class="text">Cerrar sesion</span></a></li>
  </ul>
</div>
